...
<div class=topleft onclick="document.location='checkIn.action';"><h1> 
  ...
  <div id="container">
<br><br><br>
<div class="label">删除组织</div>
<br><br>
<div id="tw-outer">
<div id="tw">
<s:form action="deleteorg" method="post" id="addClient" namespace="/org">
<!-- id/////////// -->
<div id='name' class='outerDiv'>
<label for="name">组织id:</label> 
<input type="text" name="orgid" required="required"/> 
<div class='message' id='nameDiv'> 请填写要删除的组织ID </div>
</div>
