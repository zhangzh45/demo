...
<div class=topleft onclick="document.location='checkIn.action';"><h1> 
  ...
  <div id="container">
<br><br><br>
<div class="label">添加职位</div>
<br><br>
<div id="tw-outer">
<div id="tw">
<s:form action="addpos" method="post" id="addClient" namespace="/position">

<!-- roleid //////////////////////////////////////////////////////-->
<div id='username' class='outerDiv'>
<label for="username">角色id:</label> 
<input type="text" name="roleid" required="required"/> 
<div class='message' id='usernameDiv'> Enter the id of the role(number only). </div>
</div>
<div class='clearfix'></div>
<!-- posname /////////////////////////////////////////////////-->
<div id='username' class='outerDiv'>
<label for="username">职位名:</label> 
<input type="text" name="posname" required="required"/> 
<div class='message' id='usernameDiv'> Enter the name of the position. </div>
</div>
<div class='clearfix'></div>
<div class="omg">
