...
<div class=topleft onclick="document.location='checkIn.action';"><h1> 
  ...
  <div id="container">
<br><br><br>
<div class="label">添加能力</div>
<br><br>
<div id="tw-outer">
<div id="tw">
<s:form action="addabi" method="post" id="addClient" namespace="/client">

<!-- orgname /////////////////////////////////////////////////-->
<div id='username' class='outerDiv'>
<label for="username">能力名称:</label> 
<input type="text" name="abiname" required="required"/> 
<div class='message' id='usernameDiv'> Enter the name of the Ability. </div>
</div>
<div class='clearfix'></div>
<!-- parentid //////////////////////////////////////////////////////-->
<div id='username' class='outerDiv'>
<label for="username">描述信息:</label> 
<input type="text" style="height:51px;width:449px" name="specification" required="required"/> 
<div class='message' id='usernameDiv'> Enter the specification of the ability. </div>
</div>
<div class='clearfix'></div>
<div class="omg">
