...
<form action="addabi" method="get">
  <p>Ability name: <input type="text" name="abiname" /></p> 
  <p>详情：<input class="submit1" type="text" name="specification"/></p>
