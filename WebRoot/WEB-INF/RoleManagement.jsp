...
<form action="addrole" method="get">
  <p>Role name: <input type="text" name="rolename" /></p>
  <input type="submit" value="添加" />
	...
	<br/>		 
	    ...
	    <script type="text/javascript" >
         var code;
          var treeId = 0;
          function deleteRoleSpecSer(roleid){
		$.ajax({
			    url: "deleteRole1.action",
			    type: "post",
			    async: false,
			    data: {"roleid":roleid},
			    dataType: "json",
    ...
    "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
				$('td:eq(2)', nRow).html("<button class='btn btn-primary' onclick='deleteRoleSpecSer(\""+ aData.roleid+"\")'>Delete</button>");
				return nRow;
		},
