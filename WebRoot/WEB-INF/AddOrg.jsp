...
<div class=topleft onclick="document.location='checkIn.action';"><h1> 
  ...
  <div id="container">
<br><br><br>
<div class="label">添加组织</div>
<br><br>
<div id="tw-outer">
<div id="tw">
<s:form action="addorg" method="post" id="addClient" namespace="/client">

<!-- orgname /////////////////////////////////////////////////-->
<div id='username' class='outerDiv'>
<label for="username">组织名:</label> 
<input type="text" name="orgname" required="required"/> 
<div class='message' id='usernameDiv'> Enter the name of the organization. </div>
</div>
<div class='clearfix'></div>
<!-- parentid //////////////////////////////////////////////////////-->
<div id='username' class='outerDiv'>
<label for="username">父组织id:</label> 
<input type="text" name="parentorgid" required="required"/> 
<div class='message' id='usernameDiv'> Enter the parentid of the organization. </div>
</div>
<div class='clearfix'></div>
<div class="omg">
