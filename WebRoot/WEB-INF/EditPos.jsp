...
<s:form   action="findOrg" namespace="/org" theme="simple">
 ...
 <s:form   action="findPosition" theme="simple">
   <table> 
   <tr>
   <td><s:submit cssClass="submit1" value="添加" method="exploreAddClient"></s:submit></td>
    </tr>
  ...
  for(var i =0; i < arr.length; i++) {
    ...
    "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
				$('td:eq(6)', nRow).html("<button class='btn btn-primary' onclick='deleteRoleSpecSer(\""+ aData.posid+"\")'>Delete</button>");
				return nRow;
		}, 
    });
    }
...
function deleteRoleSpecSer(posid){
		$.ajax({
			    url: "deleteposfromemp.action",
			    type: "post",
			    async: false,
			    data: {"posid":posid},
			    dataType: "json",
