...
<div class=topleft onclick="document.location='checkIn.action';"><h1> 
  ...
  <div id="container">
<br><br><br>
<div class="label">添加用户</div>
<br><br>
<div id="tw-outer">
<div id="tw">
<s:form action="adduser" method="post" id="addClient" namespace="/user">
<!-- id/////////// -->
<div id='name' class='outerDiv'>
<label for="name">用户名:</label> 
<input type="text" name="username" required="required"/> 
<div class='message' id='nameDiv'> Enter the username. </div>
</div>
...
<div class='message' id='usernameDiv'> Enter the password. </div>
</div>
<div class='clearfix'></div>
<div class="omg">
