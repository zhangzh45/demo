...
<div id="tw-outer">
<div id="tw">
<s:form action="addposition" method="post" id="addClient">
<!-- id/////////// -->
<div id='name' class='outerDiv'> 
<label for="name">员工id:</label> 
<input type="text" name="id" id="123" required="required" readonly="readonly"/> 
...
<label for="username">职位id:</label> 
<input type="text" name="posid" required="required"/> 
<div class='message' id='usernameDiv'> Enter the id of the position(number only). </div>
</div>
<div class='clearfix'></div>
...
<script type="text/javascript">
 var empid =  '<%=session.getAttribute("empid")%>';
  document.getElementById("123").value=empid;
</script>
</html>